...
def DFT_matrix(N):
    ...
    #raise NotImplementedError('`DFT_matrix` function in ' + '`dft.py` needs to be implemented')
    #############################################################################
    #                             END OF YOUR CODE
    ############################################################################
...
def my_dft(img):
    ...
    #raise NotImplementedError('`my_dft` function in ' + '`dft.py` needs to be implemented')
...
def dft_filter(img):
    ...
    #raise NotImplementedError('`dft_filter` function in ' + '`dft.py` needs to be implemented')
