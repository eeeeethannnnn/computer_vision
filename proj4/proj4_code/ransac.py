...
def calculate_num_ransac_iterations(prob_success: float,
    ...
    # TODO: YOUR CODE HERE
    ############################################################################
    num_iterations = math.ceil(math.log10(1 - prob_success) / math.log10(1 - ind_prob_correct ** sample_size)) 
    ############################################################################
    #                             END OF YOUR CODE
    ############################################################################
...
def ransac_projection_matrix(pts2d: np.ndarray,
    ...
    for _ in range(num_iterations):
        ...
        # TODO: YOUR CODE HERE
        ########################################################################
        inliers = find_inliers(pts2d, pts3d, estimate_camera_matrix(sampled_pts2d, sampled_pts3d, estimate_projection_matrix_dlt(sampled_pts2d, sampled_pts3d)), inlier_threshold)
